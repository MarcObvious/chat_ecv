...
//to store data
$.getJSON("http://84.89.136.194/server.php", { action:"set", key:"name", value:"javi" }, function (result) {
	console.log(result);
});

//to recove data
$.getJSON("http://84.89.136.194/server.php", { action:"get", key:"name2" }, function (result) {
	//result.msg == "key not found" if not found, otherwise result.data has the value
	console.log(result);
});
